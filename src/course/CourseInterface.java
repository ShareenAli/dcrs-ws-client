 ...
 * 
 */
@WebService(name = "CourseInterface", targetNamespace = "http://course/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CourseInterface {
    ...
    @Action(input = "http://course/CourseInterface/validateStudentRequest", output = "http://course/CourseInterface/validateStudentResponse")
    ...
    @Action(input = "http://course/CourseInterface/validateAdvisorRequest", output = "http://course/CourseInterface/validateAdvisorResponse")
    ...
    @Action(input = "http://course/CourseInterface/addCourseRequest", output = "http://course/CourseInterface/addCourseResponse")
    ...
    @Action(input = "http://course/CourseInterface/showCoursesRequest", output = "http://course/CourseInterface/showCoursesResponse")
    ...
    @Action(input = "http://course/CourseInterface/deleteCourseRequest", output = "http://course/CourseInterface/deleteCourseResponse")
    ...
    @Action(input = "http://course/CourseInterface/enrollCourseRequest", output = "http://course/CourseInterface/enrollCourseResponse")
    ...
    @Action(input = "http://course/CourseInterface/displayCoursesRequest", output = "http://course/CourseInterface/displayCoursesResponse")
    ...
    @Action(input = "http://course/CourseInterface/dropCourseRequest", output = "http://course/CourseInterface/dropCourseResponse")
    ...
    @Action(input = "http://course/CourseInterface/getClassScheduleRequest", output = "http://course/CourseInterface/getClassScheduleResponse")
    ...
    @Action(input = "http://course/CourseInterface/listCourseAvailabilityRequest", output = "http://course/CourseInterface/listCourseAvailabilityResponse")
    ...
    @Action(input = "http://course/CourseInterface/swapCourseRequest", output = "http://course/CourseInterface/swapCourseResponse")
